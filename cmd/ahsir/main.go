...
func usage() {
	...
	fmt.Println("  chat <agent> \"<message>\" [--context ID] [--as NAME] [--require-path PATH]")
	...
	fmt.Println("  doctor [--config path] [--json]      Health checklist: config, provider CLIs, scheduler, agents, auth")
